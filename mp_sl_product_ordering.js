    ...
    function(ui, email, runtime, search, record, http, log, redirect, format) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                createCustomRecord(zee_id, b4, g500, kg1, kg3, kg5, kg1_toll, kg3_toll, kg5_toll);
                var form = ui.createForm({
        ...
        function createCustomRecord(zee_id, b4, g500, kg1, kg3, kg5, kg1_toll, kg3_toll, kg5_toll) {
            ...
            if (activeOrder != 0) {
                ...
                mpexOrderRec.setValue({
                    ...
                    value: b4 + g500 + kg1 + kg3 + kg5 + g500_toll + kg1_toll + kg3_toll + kg5_toll
                });
                ...
                mpexOrderRec.setValue({
                    fieldId: 'custrecord_mpex_order_total',
                    value: b4 + g500 + kg1 + kg3 + kg5 + kg1_toll + kg3_toll + kg5_toll
                });
        ...
        function inputFieldsToll(g500, kg1, kg3, kg5, test) {
            ...
            if (test) {
                ...
                inlineQty += '<div class="col-xs-6 g500_env_toll"><div class="input-group"><span class="input-group-addon" id="500g">500G SATCHEL  </span><input id="500g_text_toll" type="text" class="form-control "  value="DISCONTINUED" readonly/></div></div>';
